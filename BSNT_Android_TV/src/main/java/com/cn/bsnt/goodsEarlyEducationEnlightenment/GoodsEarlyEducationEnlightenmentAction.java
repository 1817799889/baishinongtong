package com.cn.bsnt.goodsEarlyEducationEnlightenment;
...
public class GoodsEarlyEducationEnlightenmentAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryEducationEnlightenment();
		...
		json.put("earlyEductionEnlightenmentList", list_rtn);
