package com.cn.bsnt.goodsDigiyalAccessories;
...
public class GoodsDigiyalAccessoriesAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryDigiyalAccessories(list);
		...
		json.put("selectDigiyalAccessoriesList", list_rtn);
