package com.cn.bsnt.goodsFitnessEquipment;
...
public class GoodsFitnessEquipmentAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryFitnessEquipment();
		...
		json.put("fitnessEquipmentList", list_rtn);
