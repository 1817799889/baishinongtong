package com.cn.bsnt.goodsMicrowaveOven;
...
public class GoodsMicrowaveOven extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryMicrowaveOven();
		...
		json.put("microwaveOvenList", list_rtn);
