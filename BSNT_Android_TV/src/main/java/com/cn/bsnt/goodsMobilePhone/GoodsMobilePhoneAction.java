package com.cn.bsnt.goodsMobilePhone;
...
public class GoodsMobilePhoneAction extends HttpServlet{
	@Override
...
//	list.add("list");
	...
	json.put("mobilePhoneList", list_rtn);
