package com.cn.bsnt.goodsVideoPlayOrgan;
...
public class GoodsVideoPlayOrganAction extends HttpServlet{
	@Override
...
//	list.add("list");
	...
	list.add(goodsType);
	list_rtn=db.goodsVideoPlayOrgan();
	...
	json.put("videoPlayOrganList", list_rtn);
