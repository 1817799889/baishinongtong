package com.cn.bsnt.goodsBoxSpringSuite;
...
public class GoodsBoxSpringSuiteAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryBoxSpringSuite();
		...
		json.put("boxSpringSuiteList", list_rtn);
