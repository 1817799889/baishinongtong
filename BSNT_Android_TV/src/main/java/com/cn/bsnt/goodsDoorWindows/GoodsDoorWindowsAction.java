package com.cn.bsnt.goodsDoorWindows;
...
public class GoodsDoorWindowsAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		json.put("doorWindowsList", list_rtn);
