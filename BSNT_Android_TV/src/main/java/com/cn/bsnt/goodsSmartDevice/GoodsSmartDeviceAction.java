package com.cn.bsnt.goodsSmartDevice;
...
public class GoodsSmartDeviceAction extends HttpServlet{
	@Override
...
//	list.add("list");
	...
	json.put("smartDeviceList", list_rtn);
