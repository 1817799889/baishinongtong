package com.cn.bsnt.goodsDecorateBuildingmaterials;
...
public class GoodsDecorateBuildingmaterialsAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryBuildingMaterials();
		...
		json.put("decorateBuildingmaterialsList", list_rtn);
