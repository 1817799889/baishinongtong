package com.cn.bsnt.goodsOutdoorGoods;
...
public class GoodsOutdoorGoodsAction extends HttpServlet{
	@Override
...
//	list.add("list");
	...
	json.put("outdoorGoodsList", list_rtn);
