package com.cn.bsnt.goodsMedicaCare;
...
public class GoodsMedicaCareAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryMedicacare(list);
		...
		json.put("medicacareList", list_rtn);
