package com.cn.bsnt.goodsGrainOilTaste;
...
public class GoodsGrainOilTasteAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryGrainOilTaste();
		...
		json.put("grainOilTasteList", list_rtn);
