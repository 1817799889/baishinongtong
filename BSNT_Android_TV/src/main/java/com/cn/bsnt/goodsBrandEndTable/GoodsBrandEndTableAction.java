package com.cn.bsnt.goodsBrandEndTable;
...
public class GoodsBrandEndTableAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryBrandEndTable();
		...
		json.put("brandEndTableList", list_rtn);
