package com.cn.bsnt.goodsCleaning;
...
public class GoodsCleaningAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryCleaning(list);
		...
		json.put("selectCleaningList", list_rtn);
