package com.cn.bsnt.goodsHomeTextiles;
...
public class GoodsHomeTextilesAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		list.add(goodsType);
		list_rtn = db.queryHomeTextiles(list);
		...
		json.put("homeTextilesList", list_rtn);
